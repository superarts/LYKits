...
- (void)viewDidLoad
{
	...
	self.view.backgroundColor = [UIColor colorNamed:@"background.png"];
...
- (void)tableView:(UITableView*)tableView didSelectRowAtIndexPath:(NSIndexPath*)indexPath
{
	if (indexPath.section == 0 && indexPath.row == 0) {
		...
		//[nav.navigationBar setBackgroundImage:[UIImage imageNamed:@"Navbar_background.png"] forBarMetrics:UIBarMetricsDefault];
		nav.navigationBar.translucent = NO;
		nav.navigationBar.barTintColor = [UIColor colorWithRed:52.0/255.0 green:142.0/255.0 blue:91.0/255.0 alpha:1];
