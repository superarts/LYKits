...
- (void)loadView
{
    ...
    if (UI_USER_INTERFACE_IDIOM() != UIUserInterfaceIdiomPad && [[UIScreen mainScreen] bounds].size.height > 480) {
		...
		//backgroundTableView.backgroundView = nil;
		//backgroundTableView.backgroundColor = [UIColor redColor];
		//self.view.backgroundColor = [UIColor redColor];
        [self.view addSubview:backgroundTableView];
		//self.view.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
		//backgroundTableView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
	...
	_enterPasscodeTableView.backgroundColor = [UIColor colorNamed:@"background.png"];
	//_enterPasscodeTableView.backgroundView = nil;
	//_enterPasscodeTableView.backgroundColor = [UIColor blueColor];
	...
	_setPasscodeTableView.backgroundColor = [UIColor colorNamed:@"background.png"];
	//_setPasscodeTableView.backgroundView = nil;
	//_setPasscodeTableView.backgroundColor = [UIColor yellowColor];
	...
	_confirmPasscodeTableView.backgroundColor = [UIColor colorNamed:@"background.png"];
	//_confirmPasscodeTableView.backgroundView = nil;
	//_confirmPasscodeTableView.backgroundColor = [UIColor blackColor];
...
- (void)moveToNextTableView
{
	...
	newTableView.frame = CGRectMake(self.view.frame.origin.x, self.view.frame.origin.y - 64, self.view.frame.size.width, self.view.frame.size.height);
...
- (void)moveToPreviousTableView
{
	...
	[UIView setAnimationDuration:0.25];
	oldTableView.frame = CGRectMake(oldTableView.frame.origin.x + self.view.bounds.size.width, oldTableView.frame.origin.y, oldTableView.frame.size.width, oldTableView.frame.size.height);
	//if ([self.navigationItem.title isEqual:@""])
	//newTableView.frame = self.view.frame;
	newTableView.frame = CGRectMake(self.view.frame.origin.x, self.view.frame.origin.y - 64, self.view.frame.size.width, self.view.frame.size.height);
	[UIView commitAnimations];
